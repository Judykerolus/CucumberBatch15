...
public class Log {
    ...
    // verify: Runs and checks on the results of integration tests to ensure quality criteria is met
    // install: Installs the packages into local repository (in .m2 folder)
